...
string CalculateLivingAllowance(char employmentStatus, DateTime dateOfJoining, double basicPay)
{
...
string CalculateBounus(char employmentStatus, DateTime dateOfJoining, double basicPay){
    double bonus = 0;
    int experienceInYears = 0;
    TimeSpan experience = DateTime.Now - dateOfJoining;
    experienceInYears = (int)(experience.TotalDays / 365);
